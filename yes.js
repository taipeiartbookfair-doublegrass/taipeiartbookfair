document.addEventListener('DOMContentLoaded', function () {
    ...
    var participatedYearsDivs = document.querySelectorAll('.question-ParticipatedYears');
    ...
    function toggleVisibility(show) {
        participatedYearsDivs.forEach(function (div) {
            ...
            if (!show) {
                // 重置选择状态
                div.querySelectorAll('input[type="checkbox"], input[type="radio"]').forEach(function (input) {
                    input.checked = false;
                });
            }
        });
    ...
    var insufficientInfoAgree = document.getElementById('InsufficientInformation_Agree');
    var insufficientInfoDisagree = document.getElementById('InsufficientInformation_Disagree');
