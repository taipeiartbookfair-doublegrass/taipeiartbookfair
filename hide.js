document.addEventListener("DOMContentLoaded", function () {
    // 选择对应的input元素
    var largeBookStalls = document.getElementById('PreferredBoothType_LargeBookStalls');
    var smallBookStalls = document.getElementById('PreferredBoothType_SmallBookStalls');
    var creativeProducts = document.getElementById('PreferredBoothType_CreativeProducts');
    var foodBeverages = document.getElementById('PreferredBoothType_FoodBeverages');
