...
const imageFiles = [
  ...
  "019.jpg", "020.jpg", "021.jpg", "023.jpg", "024.jpg", "025.jpg", "026.jpg", "027.jpg", "028.jpg", 
  "029.jpg", "030.jpg"
];
...
function createRotator() {
  ...
  for (let i = 0; i < totalPosters; i++) {
    ...
    if (selectedImages.length < imagesPerStrip) {
      selectedImages.push(...shuffle(imageFiles).slice(0, imagesPerStrip - selectedImages.length));
    }
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function rotateImages() {
    ...
    current++;
    if (current === rotataDivs[0].querySelector('.image-strip').children.length) {
  ...
  setInterval(rotateImages, 5000);  // Adjust timing for your effect speed
    ...
    // SPAMMER
    const phrases = [
      "來嘛來嘛", "經過不要放過", "要來嗎", "快來喔", "嗯...所以...那個...你要來嗎？",
      "好嘛～來嘛來嘛", "來這邊", "來喔來喔", "來來草率季", "一起玩一起玩", 
      "蛤～來了嗎？", "叩叩叩...你在哪？", "錯過了怎麼辦QQ", "不來怎麼辦", "呦齁！這邊不錯喔！來看看",
      "是個好機會", "很好玩內", "來這邊看", "來來草率季喔", "嗨嘍世界"
    ];
